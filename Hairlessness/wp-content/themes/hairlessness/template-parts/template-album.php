    ...
    <main>
        <div class="content">
            ...
            <section class="photo">
                ...
                <h2 aria-level="2" role="heading" class="title" id="anciens"><?php the_sub_field('title'); ?></h2>
            ...
            <section class="photo">
                ...
                <h2 aria-level="2" role="heading" class="title" id="chatterie"><?php the_sub_field('title'); ?></h2>
                <div><p><?php the_sub_field('introduction'); ?></p></div>
                <div class="gallery">
                    <?php
                    $images = get_sub_field('photos');
            ...
            <section class="photo">
                ...
                <h2 aria-level="2" role="heading" class="title" id="former"><?php the_sub_field('title'); ?></h2>
                <div><p><?php the_sub_field('introduction'); ?></p></div>
                <div class="gallery">
                    <?php
                    $images = get_sub_field('photos');
