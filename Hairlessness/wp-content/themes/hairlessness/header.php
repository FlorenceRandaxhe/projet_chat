...
<head>
	...
	<meta name="keywords" content="Hairlessness, Chatons, Sphynx, chats reproducteurs, Contact, Historique, Album, Livre d’or">
    ...
    <?php if ( is_front_page() ): ?>
        <div class="banner">
            <div class="banner-content">
                <h1 aria-level="1" role="heading" class="banner_headline"><?php bloginfo('name'); ?><span class="hidden"> - Accueil</span></h1>
                <div class="banner_text">
                    <p><?php bloginfo('description'); ?></p>
                </div>
                <div class="banner_link">
                    <a href="<?= hl_get_page_url('template-historique.php'); ?>#chatterie" title="Vers la page historique de la chatterie">&Agrave; propos de nous</a>
                </div>
            </div>
        </div>
    <?php else : ?>
        ...
        <div class="header_wrapper">
            ...
            <div class="navigation">
                ...
                <label for="menu" class="menu-icon">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 55.83 34.33" width="35" height="35">
                        <g><line y1="1.5" x2="55.83" y2="1.5"/><line y1="17.17" x2="55.83" y2="17.17"/><line y1="32.83" x2="55.83" y2="32.83"/></g>
                    </svg>
                </label>
